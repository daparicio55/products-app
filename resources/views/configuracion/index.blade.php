...
@section('content')
    <!-- Page Heading -->
    <x-text-header label="Configuración de la Empresa" />
            ...
            <div class="card-body">
                <div class="row g-4">
                    <div class="col-sm-12 col-md-4 mt-3">
                        <x-input-text label="Correo" name="company_email" :value="$user->company_email" />
                    </div>
                    ...
                    <div class="col-sm-12 mt-3">
                        <x-input-group label="RUC" name="company_ruc" button_text="Buscar" :value="$user->company_ruc"/>
                    </div>

                    <div class="col-sm-12 col-md-6 mt-3">
                        <x-input-text label="Razón Social" name="company_razon_social" :value="$user->company_razon_social"/>
                    </div>

                    <div class="col-sm-12 col-md-6 mt-3">
                        <x-input-text label="Nombre Comercial" name="company_nombre_comercial" :value="$user->company_nombre_comercial" />
                    </div>

                    <div class="col-sm-12 col-md-3 mt-3">
                        <x-input-text label="Provincia" name="company_departamento" :value="$user->company_departamento"/>
                    </div>

                    <div class="col-sm-12 col-md-3 mt-3">
                        <x-input-text label="Departamento" name="company_provincia" :value="$user->company_provincia"/>
                    </div>

                    <div class="col-sm-12 col-md-3 mt-3">
                        <x-input-text label="Distrito" name="company_distrito" :value="$user->company_distrito"/>
                    </div>

                    <div class="col-sm-12 col-md-3 mt-3">
                        <x-input-text label="Urbanización" name="company_urbanizacion" :value="$user->company_urbanizacion"/>
                    </div>

                    <div class="col-sm-12 col-md-8 mt-3">
                        <x-input-text label="Dirección" name="company_direccion" :value="$user->company_direccion"/>
                    </div>

                    <div class="col-sm-12 col-md-4 mt-3">
                        <x-input-text label="Ubigeo" name="company_ubigeo" :value="$user->company_ubigeo"/>
                    </div>
